<?php
/**
 * View: Formulário de cadastro de livro.
 * Variáveis recebidas do Controller:
 *   $erros — array de mensagens de erro (validação)
 *   $dados — array com os dados já preenchidos (para repopular)
 */
...
<div class="container">
    ...
    <header class="page-header">
        <div class="page-header__left">
            <h1 class="page-header__title">
                <i class="fa-solid fa-book-medical"></i> Novo Livro
            </h1>
            <p class="page-header__subtitle">Cadastrar novo exemplar no acervo</p>
        </div>
    ...
    <div class="form-page">
        ...
        <div class="form-card">
            <h2 class="form-card__title"><i class="fa-solid fa-book"></i> Cadastrar Livro</h2>
            <p class="form-card__subtitle">Preencha as informações do novo livro</p>
            ...
            <form action="index.php?acao=salvar" method="POST">
                ...
                <div class="form-actions">
                    ...
                    <button type="submit" class="btn btn--primary"><i class="fa-solid fa-plus"></i> Cadastrar Livro</button>
                </div>
